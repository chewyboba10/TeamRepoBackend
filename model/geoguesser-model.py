...
class Geoguesser(db.Model):
    # Table name
    __tablename__ = 'geoguesser'
...
def initScores():
    with app.app_context():
        ...
        u1 = Geoguesser('Evan', '500', date(2023, 1, 22))
        u2 = Geoguesser('Max', '650', date(2023, 1, 21))
        u3 = Geoguesser('Kalani', '0', date(2023, 1, 20))
        u4 = Geoguesser('Nathan', '650', date(2023, 1, 19))
        u5 = Geoguesser('Jaden', '1100', date(2023, 1, 22))
